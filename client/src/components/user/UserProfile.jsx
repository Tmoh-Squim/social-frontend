...
const Profile = ({ member, setOpen }) => {
  ...
  return (
    <div className="px-2 bg-neutral-900 py-2 absolute h-screen overflow-y-scroll sidebar top-0 left-0 right-0 w-full z-30 block 800px:flex 800px:px-6 800px:items-center ">
